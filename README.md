...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([38.93.2](https://github.com/renovatebot/renovate/releases/tag/38.93.2), today) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
...
- [kubernetes-sigs/image-builder](https://github.com/kubernetes-sigs/image-builder) ([v0.1.35](https://github.com/kubernetes-sigs/image-builder/releases/tag/v0.1.35), 3 days ago) - Tools for building Kubernetes disk images
- [kyverno/kyverno](https://github.com/kyverno/kyverno) ([v1.12.6-rc.2](https://github.com/kyverno/kyverno/releases/tag/v1.12.6-rc.2), 4 days ago) - Cloud Native Policy Management
...
- [fix: typo in watchdogConfig](https://github.com/seriohub/velero-helm/pull/47) on [seriohub/velero-helm](https://github.com/seriohub/velero-helm) (3 days ago)
