...
- [adobe/himl](https://github.com/adobe/himl) - A hierarchical yaml config in Python (4 days ago)
...
- [alikhil/kubectl-find](https://github.com/alikhil/kubectl-find) - Missing kubectl UNIX-find-like plugin to find resources and perform action on them (1 day ago)
...
- [browserbase/stagehand](https://github.com/browserbase/stagehand) - The AI Browser Automation Framework (6 days ago)
- [vosen/ZLUDA](https://github.com/vosen/ZLUDA) - CUDA on non-NVIDIA GPUs (6 days ago)
- [marcosnils/bin](https://github.com/marcosnils/bin) - Effortless binary manager (1 week ago)
- [Factory-AI/factory](https://github.com/Factory-AI/factory) - Factory - Agent-Native Software Development (1 week ago)
...
- [commercetools/telefonistka](https://github.com/commercetools/telefonistka) - Safe and Controlled GitOps Promotion Across Environments/Failure-Domains (2 weeks ago)
