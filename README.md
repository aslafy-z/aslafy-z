...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([38.132.2](https://github.com/renovatebot/renovate/releases/tag/38.132.2), today) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
...
- [argoproj/argo-workflows](https://github.com/argoproj/argo-workflows) ([v3.6.0-rc3](https://github.com/argoproj/argo-workflows/releases/tag/v3.6.0-rc3), 3 days ago) - Workflow Engine for Kubernetes
- [kyverno/kyverno](https://github.com/kyverno/kyverno) ([v1.13.0-rc.3](https://github.com/kyverno/kyverno/releases/tag/v1.13.0-rc.3), 5 days ago) - Cloud Native Policy Management
...
- [jkroepke/helm-secrets](https://github.com/jkroepke/helm-secrets) ([v4.6.2](https://github.com/jkroepke/helm-secrets/releases/tag/v4.6.2), 2 weeks ago) - A helm plugin that help manage secrets with Git workflow and store them anywhere

#### 🔨 My recent Pull Requests

- [feat(artifacts): add git https insecure option. Fixes #10762](https://github.com/argoproj/argo-workflows/pull/13797) on [argoproj/argo-workflows](https://github.com/argoproj/argo-workflows) (5 days ago)
...
- [carina-io/carina](https://github.com/carina-io/carina) - Carina: an high performance and ops-free local storage for kubernetes (2 days ago)
