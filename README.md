...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([38.124.1](https://github.com/renovatebot/renovate/releases/tag/38.124.1), today) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
- [kubernetes/ingress-nginx](https://github.com/kubernetes/ingress-nginx) ([controller-v1.12.0-beta.0](https://github.com/kubernetes/ingress-nginx/releases/tag/controller-v1.12.0-beta.0), today) - Ingress NGINX Controller for Kubernetes
