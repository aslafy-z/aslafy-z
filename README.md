...
- [hashicorp/vault-k8s](https://github.com/hashicorp/vault-k8s) - First-class support for Vault and Kubernetes. (4 weeks ago)
...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) ([38.32.0](https://github.com/renovatebot/renovate/releases/tag/38.32.0), today) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io
...
- [microsoft/retina](https://github.com/microsoft/retina) ([v0.0.14](https://github.com/microsoft/retina/releases/tag/v0.0.14), 2 days ago) - eBPF distributed networking observability tool for Kubernetes
- [stakater/application](https://github.com/stakater/application) ([v4.2.5](https://github.com/stakater/application/releases/tag/v4.2.5), 4 days ago) - Generic helm chart for all kind of applications
- [jkroepke/helm-secrets](https://github.com/jkroepke/helm-secrets) ([v4.6.1](https://github.com/jkroepke/helm-secrets/releases/tag/v4.6.1), 6 days ago) - A helm plugin that help manage secrets with Git workflow and store them anywhere
...
- [feat: generated Helm documentation](https://github.com/stakater/application/pull/335) on [stakater/application](https://github.com/stakater/application) (4 weeks ago)
...
- [cables-gl/cables](https://github.com/cables-gl/cables) - cables is a tool for creating beautiful interactive content (today)
- [Xide/helm-chart-diff](https://github.com/Xide/helm-chart-diff) - Visualize changes in Helm charts values.yaml between versions (6 days ago)
